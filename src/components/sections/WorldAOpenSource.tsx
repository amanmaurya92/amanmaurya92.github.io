      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Repo Node 1 */}
            <div className="border border-white/10 bg-surface/30 p-8 rounded-none hover:border-accent-violet/50 transition-colors group cursor-crosshair">
              <div className="flex justify-between items-start mb-12">
                <div>
                  <h3 className="text-4xl font-bold text-white mb-2">swift-java</h3>
              ...
              <div className="flex gap-4">
                <div className="flex-1 h-32 bg-background border border-white/5 rounded-none flex flex-col justify-end p-3 gap-1 overflow-hidden relative">
            ...
            {/* Repo Node 2 */}
            <div className="border border-white/10 bg-surface/30 p-8 rounded-none hover:border-accent-cyan/50 transition-colors group cursor-crosshair">
              <div className="flex justify-between items-start mb-12">
                <div>
                  <h3 className="text-4xl font-bold text-white mb-2">sourcekit-lsp</h3>
                  <p className="text-white/50 text-sm font-mono">Apple / Swift Ecosystem</p>
                </div>
        ...
        >
          ...
          <div className="relative border border-white/10 bg-surface/50 backdrop-blur-xl rounded-none p-8 md:p-12 overflow-hidden group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
              <div className="flex flex-col gap-4">
                <div className="w-12 h-12 rounded-none bg-background border border-white/10 flex items-center justify-center text-accent-green">
              ...
              <div className="flex flex-col gap-4">
                ...
                <h4 className="text-2xl font-bold text-white">Infrastructure</h4>
              ...
              <div className="flex flex-col gap-4">
                ...
                <h4 className="text-2xl font-bold text-white">Initiatives</h4>
