...
export default function ProjectDetail() {
  ...
  useEffect(() => {
    ...
    getProject(id)
      ...
      .catch(() => {
        setApiError("Could not reach the API. This project may be unavailable.");
      ...
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          {loading ? (
            ...
            <>
              {project.imageUrl && (
                <div className="mb-8 overflow-hidden rounded-2xl border border-slate-200/80 bg-slate-900/5 dark:border-slate-700/80">
                  <img
